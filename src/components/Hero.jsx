  ...
  return (
    <header className='w-full flex justify-center items-center flex-col'>
      <nav className='flex justify-between items-center w-full mb-10 p-3 border-b-2 border-solid border-purple-200'>
        ...
        <h1 className="py-1.5 px-5 text-purple-900 font-medium text-lg transition-all hover:bg-white hover:text-black">sumariza</h1>
      ...
      <h1 className='head_text'>
        ...
        <span className='purple_gradient '>SUMARIZA</span>
      </h1>
      <h2 className='desc'>
      Simplify your reading with Sumariza, an article summarizer that creates concise summaries from lengthy articles.      </h2>
    </header>
  );
};
